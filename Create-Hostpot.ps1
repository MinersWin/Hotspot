 ...
 <#
    ...
    Author: MinersWin
    Github: github.com/MinersWin

    Purpose: Help manage and create wireless networks on Windows based computers
 #>
...
[string] $MenuBar = "`n=========== Wifi HotSpot with PowerShell - Version 1.3.3.7 ==========="
...
while ( $menuOption -lt 1 -or $menuOption -gt $LastOption ) {
    ...
    Write-Host "`n`tgithub.com/MinersWin" 
